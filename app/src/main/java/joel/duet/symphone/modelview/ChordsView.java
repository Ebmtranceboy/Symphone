...
/**
 *
 * Created by joel on 11/03/16 at 01:50 at 01:54 at 02:16 at 09:36 at 00:14.
 */
public class ChordsView extends View {
    ...
    public ChordsView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.joel_duet_symphone_modelview_ChordsView,
                0, 0);

        try {
            isMajor = a.getBoolean(R.styleable.joel_duet_symphone_modelview_ChordsView_isMajor, false);
        } finally {
            a.recycle();
        }
        init();
    ...
    private void init() {
        post(new Runnable() {
            ...
            public void run() {
                ...
                int nchords = isMajor ? Default.Flavor.nbMajor :
