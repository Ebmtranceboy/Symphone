...
public final class Default {
    ...
    public static final int nViews = 19;
                                         // -1 welcome
    public static final Integer[] menu_icons = new Integer[]{
            ...
            R.drawable.ic_menu_pref};     // 11
                                          ...
                                          // 14 effect
                                          // 15 pattern
                                          // 16 give instrument name
                                          // 17 give efftect name
                                          // 18 select file
    ...
    public static final int INDEX_CHORDS = 13;
    public static final int INDEX_EFFECT = 14;
    public static final int INDEX_PATTERN = 15;
    public static final int INDEX_GIVE_INSTRUMENT_NAME = 16;
    public static final int INDEX_GIVE_EFFECT_NAME = 17;
    public static final int INDEX_SELECT_FILE = 18;
