...
public final class Default {
    ...
    public static final int nViews = 16;
                                         // -1 welcome
    public static final Integer[] menu_icons = new Integer[]{
            ...
            R.drawable.ic_bug_report_24dp}; // 12
                                          // 13 instrument
                                          // 14 effect
                                          // 15 pattern
    ...
    public static final int INDEX_RENDER_PROJECT = 10;
    public static final int INDEX_OPTIONS = 11;
    public static final int INDEX_REINIT_CSOUND = 12;
    public static final int INDEX_INSTRUMENT = 13;
